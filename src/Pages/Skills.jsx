...
const SkillCard = ({ name, category }) => (
  <div className="bg-[#262626] rounded-lg p-2 hover:bg-gray-600 transition-colors duration-200">
...
const SkillsSection = () => {
  ...
  const TabButton = ({ tabKey, label, isActive, onClick }) => (
    <button
      onClick={onClick}
      className={`px-6 py-2 cursor-pointer rounded-md font-medium transition-colors duration-200 ${
        isActive
    ...
    <section id="skills" className="md:py-12 py-6">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-[#262626] rounded-lg p-1 inline-flex">
            <TabButton
              tabKey="tech"
              label="Tech"
